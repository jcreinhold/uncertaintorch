...
holds definition of tiramisu network
copied from: https://github.com/MedICL-VU/LesionSeg/
...
__all__ = ['init_weights', 'FCDenseNet']
...
class FCDenseNet(nn.Module):
    ...
    def __init__(self, in_channels=3, down_blocks=(5,5,5,5,5),
        ...
        self.syn = nn.Conv2d(in_channels=cur_channels_count,
                out_channels=n_classes, kernel_size=1, stride=1,
                padding=0, bias=True)
        self.unc = nn.Conv2d(in_channels=cur_channels_count,
                out_channels=n_classes, kernel_size=1, stride=1,
                padding=0, bias=True)
        #self.tanh = nn.Tanh()
    ...
    def forward(self, x):
        ...
        yhat, s = self.syn(out), self.unc(out)
        # out = self.tanh(out)
...
def MSNetwork(input_nc, init_type='normal', init_gain=0.02):
